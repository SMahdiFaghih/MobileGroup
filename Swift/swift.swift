...
if (userInput == "createTodoItem") { 
    ...
    for item in listOfTodoItems { 
        print(item.title + "-" + item.content + "-" + item.priority) 
    } 
}